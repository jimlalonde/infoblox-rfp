...
function Diagnostic() {
  const findings = [
    ...
    { label: "Stack sprawl", title: "30+ platforms across the lead-to-opportunity lifecycle", body: "The MarTech and SalesTech stack has grown to over 30 active platforms, many with overlapping capabilities. Outreach duplicates native Marketo Sales Insight Actions. Reactful overlaps Marketo web personalization. Data flows across multiple enrichment providers without a unified strategy. The result is integration fragility, fragmented engagement data, and higher total cost of ownership." },
  ];
  return (
